...
public interface SearchResource {
  ...
  ArtifactSearchResults searchArtifacts(@QueryParam("name") GroupId name,
      ...
      @QueryParam("description") GroupId description,
      @QueryParam("artifactgroup") GroupId artifactgroup);
