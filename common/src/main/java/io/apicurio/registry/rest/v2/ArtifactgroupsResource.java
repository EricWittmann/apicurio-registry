...
import io.apicurio.registry.rest.v2.beans.ArtifactId;
import io.apicurio.registry.rest.v2.beans.ArtifactMetaData;
import io.apicurio.registry.rest.v2.beans.ArtifactSearchResults;
import io.apicurio.registry.rest.v2.beans.EditableMetaData;
import io.apicurio.registry.rest.v2.beans.GroupId;
import io.apicurio.registry.rest.v2.beans.Rule;
import io.apicurio.registry.rest.v2.beans.SortOrder;
import io.apicurio.registry.rest.v2.beans.UpdateState;
import io.apicurio.registry.rest.v2.beans.Version;
...
public interface ArtifactgroupsResource {
  ...
  Response getLatestArtifact(@PathParam("groupId") GroupId groupId,
      @PathParam("artifactId") ArtifactId artifactId);
  ...
  @Consumes("*/*")
  CompletionStage<ArtifactMetaData> updateArtifact(@PathParam("groupId") GroupId groupId,
      @PathParam("artifactId") ArtifactId artifactId, InputStream data);
  ...
  @Path("/{groupId}/artifacts/{artifactId}")
  @DELETE
  void deleteArtifact(@PathParam("groupId") GroupId groupId,
      @PathParam("artifactId") ArtifactId artifactId);
  ...
  @GET
  @Produces("application/json")
  ArtifactMetaData getArtifactMetaData(@PathParam("groupId") GroupId groupId,
      @PathParam("artifactId") ArtifactId artifactId);
  ...
  @PUT
  @Consumes("*/*")
  void updateArtifactMetaData(@PathParam("groupId") GroupId groupId,
      @PathParam("artifactId") ArtifactId artifactId, EditableMetaData data);
  ...
  VersionMetaData getArtifactVersionMetaDataByContent(@PathParam("groupId") GroupId groupId,
      @PathParam("artifactId") ArtifactId artifactId, @QueryParam("canonical") Boolean canonical,
      InputStream data);
  ...
  @GET
  @Produces("application/json")
  List<RuleType> listArtifactRules(@PathParam("groupId") GroupId groupId,
      @PathParam("artifactId") ArtifactId artifactId);
  ...
  @POST
  @Consumes("application/json")
  void createArtifactRule(@PathParam("groupId") GroupId groupId,
      @PathParam("artifactId") ArtifactId artifactId, Rule data);
  ...
  @Path("/{groupId}/artifacts/{artifactId}/rules")
  @DELETE
  void deleteArtifactRules(@PathParam("groupId") GroupId groupId,
      @PathParam("artifactId") ArtifactId artifactId);
  ...
  @GET
  @Produces("application/json")
  Rule getArtifactRuleConfig(@PathParam("groupId") GroupId groupId,
      @PathParam("artifactId") ArtifactId artifactId, @PathParam("rule") RuleType rule);
  ...
  @Produces("application/json")
  @Consumes("application/json")
  Rule updateArtifactRuleConfig(@PathParam("groupId") GroupId groupId,
      @PathParam("artifactId") ArtifactId artifactId, @PathParam("rule") RuleType rule, Rule data);
  ...
  @Path("/{groupId}/artifacts/{artifactId}/rules/{rule}")
  @DELETE
  void deleteArtifactRule(@PathParam("groupId") GroupId groupId,
      @PathParam("artifactId") ArtifactId artifactId, @PathParam("rule") RuleType rule);
  ...
  @PUT
  @Consumes("application/json")
  void updateArtifactState(@PathParam("groupId") GroupId groupId,
      @PathParam("artifactId") ArtifactId artifactId, UpdateState data);
  ...
  @PUT
  @Consumes("*/*")
  void testUpdateArtifact(@PathParam("groupId") GroupId groupId,
      @PathParam("artifactId") ArtifactId artifactId, InputStream data);
  ...
  @GET
  @Produces({"application/json", "application/graphql", "application/x-protobuf", "application/x-protobuffer"})
  Response getArtifactVersion(@PathParam("groupId") GroupId groupId,
      @PathParam("artifactId") ArtifactId artifactId, @PathParam("version") Version version);
  ...
  @GET
  @Produces("application/json")
  VersionMetaData getArtifactVersionMetaData(@PathParam("groupId") GroupId groupId,
      @PathParam("artifactId") ArtifactId artifactId, @PathParam("version") Version version);
  ...
  @PUT
  @Consumes("application/json")
  void updateArtifactVersionMetaData(@PathParam("groupId") GroupId groupId,
      @PathParam("artifactId") ArtifactId artifactId, @PathParam("version") Version version,
  ...
  @Path("/{groupId}/artifacts/{artifactId}/versions/{version}/meta")
  @DELETE
  void deleteArtifactVersionMetaData(@PathParam("groupId") GroupId groupId,
      @PathParam("artifactId") ArtifactId artifactId, @PathParam("version") Version version);
  ...
  @PUT
  @Consumes("application/json")
  void updateArtifactVersionState(@PathParam("groupId") GroupId groupId,
      @PathParam("artifactId") ArtifactId artifactId, @PathParam("version") Version version,
      UpdateState data);
  ...
  @GET
  @Produces("application/json")
  ArtifactSearchResults listArtifacts(@PathParam("groupId") GroupId groupId,
  ...
  @Produces("application/json")
  @Consumes("*/*")
  CompletionStage<ArtifactMetaData> createArtifact(@PathParam("groupId") GroupId groupId,
      @HeaderParam("X-Registry-ArtifactType") ArtifactType xRegistryArtifactType,
      @HeaderParam("X-Registry-ArtifactId") GroupId xRegistryArtifactId,
      @HeaderParam("X-Registry-Version") Version xRegistryVersion,
  ...
  @GET
  @Produces("application/json")
  VersionSearchResults listArtifactVersions(@PathParam("groupId") GroupId groupId,
      @PathParam("artifactId") ArtifactId artifactId, @QueryParam("offset") Integer offset,
  ...
  @Produces("application/json")
  @Consumes("*/*")
  CompletionStage<VersionMetaData> createArtifactVersion(@PathParam("groupId") GroupId groupId,
      @PathParam("artifactId") ArtifactId artifactId,
      @HeaderParam("X-Registry-Version") Version xRegistryVersion, InputStream data);
}
